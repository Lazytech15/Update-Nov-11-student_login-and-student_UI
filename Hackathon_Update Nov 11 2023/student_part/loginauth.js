...
const firebaseConfig = {
  ...
  //if the value from the variable pass is equal to the value of upass that the user input/    
        if(pass == upass.value){
          ...
          var student_id = docsnap.data().id;
          var subject1 = docsnap.data().fsub;
          var subject2 = docsnap.data().ssub;
          //make it global to be able to access in different js file.
          localStorage.setItem('section', section,'student_id', student_id,'sub1', subject1,'sub2', subject2);
